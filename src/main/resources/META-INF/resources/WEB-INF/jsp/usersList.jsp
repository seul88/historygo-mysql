                    ...
                    <tr>
                        ...
                        <td>
                            <form action="userDetails" method="post">
                                <input type = "hidden" name="name" value="${player.name}"> <input type="submit" class="btn btn-success m-1 pl-5 pr-5" value="Show details">
                            </form>

                            <form action="delete" method="post">
                                <input type = "hidden" name="name" value="${player.name}"> <input type="submit" class="btn btn-danger m-1 pl-5 pr-5" value="DELETE">
                            </form>
                        </td>
                    </tr>
